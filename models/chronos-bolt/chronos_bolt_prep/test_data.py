...
# Bounds on the number of observations per curve.  Chronos-Bolt's native
# context is 2048; the minimum keeps curves long enough to be meaningful.
_MIN_OBS = 50
_MAX_OBS = 2048
_PATCH_SIZE = 16
...
def run_test_data(output_dir: Path, n_samples: int = 10, *, size: str) -> None:
    ...
    print(f"  observation counts (log-uniform {_MIN_OBS}–{_MAX_OBS}): {sizes}")

    print(f"Loading chronos-bolt-{size} and computing embeddings ...")
